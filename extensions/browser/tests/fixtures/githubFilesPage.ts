...
export const progressiveDiffsListFixture = `
  <main>
    <div data-testid="progressive-diffs-list">
      <div>
        <div role="region" aria-labelledby="diff-heading-1">
          <h3 id="diff-heading-1">docs/AGENTS.md</h3>
          <table>
            <tbody>
              <tr data-line-number="12" data-side="right"><td>+ Browser workers read DESIGN.md</td></tr>
            </tbody>
      ...
      <div>
        <div role="region" aria-labelledby="diff-heading-2">
          <h3 id="diff-heading-2">extensions/browser/src/content/index.tsx</h3>
          <table>
            <tbody>
              <tr data-line-number="27" data-side="right"><td>+ mountIntentIsolation()</td></tr>
            </tbody>
